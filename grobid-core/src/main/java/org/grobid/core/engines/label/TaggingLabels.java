...
public class TaggingLabels {
    ...
    public static final TaggingLabel HEADER_PET = new TaggingLabelImpl(GrobidModels.HEADER, PET_LABEL);
    public static final TaggingLabel HEADER_RESP = new TaggingLabelImpl(GrobidModels.HEADER, RESP_LABEL);
    public static final TaggingLabel HEADER_PETLAWERS = new TaggingLabelImpl(GrobidModels.HEADER, PETLAWERS_LABEL);
    ...
    public static final TaggingLabel HEADER_CASETYPE = new TaggingLabelImpl(GrobidModels.HEADER, CASETYPE_LABEL);
    public static final TaggingLabel HEADER_EXTRA = new TaggingLabelImpl(GrobidModels.HEADER, EXTRA_LABEL);
    ...
    public static final TaggingLabel NAMES_PETITIONER_MARKER = new TaggingLabelImpl(GrobidModels.NAMES_PETITIONER, MARKER_LABEL);
    public static final TaggingLabel NAMES_PETITIONER_TITLE = new TaggingLabelImpl(GrobidModels.NAMES_PETITIONER, TITLE_LABEL);
    public static final TaggingLabel NAMES_PETITIONER_FORENAME = new TaggingLabelImpl(GrobidModels.NAMES_PETITIONER, FORENAME_LABEL);
    public static final TaggingLabel NAMES_PETITIONER_MIDDLENAME = new TaggingLabelImpl(GrobidModels.NAMES_PETITIONER, MIDDLENAME_LABEL);
    public static final TaggingLabel NAMES_PETITIONER_SURNAME = new TaggingLabelImpl(GrobidModels.NAMES_PETITIONER, SURNAME_LABEL);
    public static final TaggingLabel NAMES_PETITIONER_SUFFIX = new TaggingLabelImpl(GrobidModels.NAMES_PETITIONER, SUFFIX_LABEL);

    public static final TaggingLabel NAMES_RESPONDENT_MARKER = new TaggingLabelImpl(GrobidModels.NAMES_RESPONDENT, MARKER_LABEL);
    public static final TaggingLabel NAMES_RESPONDENT_TITLE = new TaggingLabelImpl(GrobidModels.NAMES_RESPONDENT, TITLE_LABEL);
    public static final TaggingLabel NAMES_RESPONDENT_FORENAME = new TaggingLabelImpl(GrobidModels.NAMES_RESPONDENT, FORENAME_LABEL);
    public static final TaggingLabel NAMES_RESPONDENT_MIDDLENAME = new TaggingLabelImpl(GrobidModels.NAMES_RESPONDENT, MIDDLENAME_LABEL);
    public static final TaggingLabel NAMES_RESPONDENT_SURNAME = new TaggingLabelImpl(GrobidModels.NAMES_RESPONDENT, SURNAME_LABEL);
    public static final TaggingLabel NAMES_RESPONDENT_SUFFIX = new TaggingLabelImpl(GrobidModels.NAMES_RESPONDENT, SUFFIX_LABEL);

    public static final TaggingLabel NAMES_PETITIONERLAWER_MARKER = new TaggingLabelImpl(GrobidModels.NAMES_PETITIONERLAWER, MARKER_LABEL);
    public static final TaggingLabel NAMES_PETITIONERLAWER_TITLE = new TaggingLabelImpl(GrobidModels.NAMES_PETITIONERLAWER, TITLE_LABEL);
    public static final TaggingLabel NAMES_PETITIONERLAWER_FORENAME = new TaggingLabelImpl(GrobidModels.NAMES_PETITIONERLAWER, FORENAME_LABEL);
    public static final TaggingLabel NAMES_PETITIONERLAWER_MIDDLENAME = new TaggingLabelImpl(GrobidModels.NAMES_PETITIONERLAWER, MIDDLENAME_LABEL);
    public static final TaggingLabel NAMES_PETITIONERLAWER_SURNAME = new TaggingLabelImpl(GrobidModels.NAMES_PETITIONERLAWER, SURNAME_LABEL);
    public static final TaggingLabel NAMES_PETITIONERLAWER_SUFFIX = new TaggingLabelImpl(GrobidModels.NAMES_PETITIONERLAWER, SUFFIX_LABEL);

    public static final TaggingLabel NAMES_RESPONDENTLAWER_MARKER = new TaggingLabelImpl(GrobidModels.NAMES_RESPONDENTLAWER, MARKER_LABEL);
    public static final TaggingLabel NAMES_RESPONDENTLAWER_TITLE = new TaggingLabelImpl(GrobidModels.NAMES_RESPONDENTLAWER, TITLE_LABEL);
    public static final TaggingLabel NAMES_RESPONDENTLAWER_FORENAME = new TaggingLabelImpl(GrobidModels.NAMES_RESPONDENTLAWER, FORENAME_LABEL);
    public static final TaggingLabel NAMES_RESPONDENTLAWER_MIDDLENAME = new TaggingLabelImpl(GrobidModels.NAMES_RESPONDENTLAWER, MIDDLENAME_LABEL);
    public static final TaggingLabel NAMES_RESPONDENTLAWER_SURNAME = new TaggingLabelImpl(GrobidModels.NAMES_RESPONDENTLAWER, SURNAME_LABEL);
    public static final TaggingLabel NAMES_RESPONDENTLAWER_SUFFIX = new TaggingLabelImpl(GrobidModels.NAMES_RESPONDENTLAWER, SUFFIX_LABEL);
    ...
    static {
        ...
        //header
        register(HEADER_PET);
        register(HEADER_RESP);
        register(HEADER_PETLAWERS);
        ...
        register(HEADER_CASETYPE);
        register(HEADER_EXTRA);
        ...
        register(NAMES_PETITIONER_MARKER);
        register(NAMES_PETITIONER_TITLE);
        register(NAMES_PETITIONER_FORENAME);
        register(NAMES_PETITIONER_MIDDLENAME);
        register(NAMES_PETITIONER_SURNAME);
        register(NAMES_PETITIONER_SUFFIX);

        register(NAMES_RESPONDENT_MARKER);
        register(NAMES_RESPONDENT_TITLE);
        register(NAMES_RESPONDENT_FORENAME);
        register(NAMES_RESPONDENT_MIDDLENAME);
        register(NAMES_RESPONDENT_SURNAME);
        register(NAMES_RESPONDENT_SUFFIX);

        register(NAMES_PETITIONERLAWER_MARKER);
        register(NAMES_PETITIONERLAWER_TITLE);
        register(NAMES_PETITIONERLAWER_FORENAME);
        register(NAMES_PETITIONERLAWER_MIDDLENAME);
        register(NAMES_PETITIONERLAWER_SURNAME);
        register(NAMES_PETITIONERLAWER_SUFFIX);

        register(NAMES_RESPONDENTLAWER_MARKER);
        register(NAMES_RESPONDENTLAWER_TITLE);
        register(NAMES_RESPONDENTLAWER_FORENAME);
        register(NAMES_RESPONDENTLAWER_MIDDLENAME);
        register(NAMES_RESPONDENTLAWER_SURNAME);
        register(NAMES_RESPONDENTLAWER_SUFFIX);
