...
public class BiblioItem {
    ...
    private AuthorEmailAssigner petitionerEmailAssigner = new ClassicAuthorEmailAssigner();
    private AuthorEmailAssigner respondentEmailAssigner = new ClassicAuthorEmailAssigner();
    private AuthorEmailAssigner petitionerlawerEmailAssigner = new ClassicAuthorEmailAssigner();
    private AuthorEmailAssigner respondentlawerEmailAssigner = new ClassicAuthorEmailAssigner();
    ...
    private List<LayoutToken> petitionersTokensWorkingCopy = new ArrayList<>();
    private List<LayoutToken> respondentsTokensWorkingCopy = new ArrayList<>();
    private List<LayoutToken> petitionerlawersTokensWorkingCopy = new ArrayList<>();
    private List<LayoutToken> respondentlawersTokensWorkingCopy = new ArrayList<>();
    ...
    public String toString() {
        return "BiblioItem{" +
                ...
                ", petitionerlawers='" + petitionerlawers + '\'' +
                ", respondentlawers='" + respondentlawers + '\'' +
                ", firstAuthorSurname='" + firstAuthorSurname + '\'' +
                ", firstPetitionerSurname='" + firstPetitionerSurname + '\'' +
                ", firstRespondentSurname='" + firstRespondentSurname + '\'' +
                ", firstPetitionerlawerSurname='" + firstPetitionerlawerSurname + '\'' +
                ", firstRespondentlawerSurname='" + firstRespondentlawerSurname + '\'' +
                ", location='" + location + '\'' +
                ", bookTitle='" + bookTitle + '\'' +
                ...
                ", petitionerlawerList=" + petitionerlawerList +
                ", respondentlawerList=" + respondentlawerList + 
                ...
                ", fullPetitioners=" + fullPetitioners +
                ", fullRespondents=" + fullRespondents +
                ", fullPetitionerlawers=" + fullPetitionerlawers +
                ", fullRespondentlawers=" + fullRespondentlawers +
                ...
                ", petitionerString='" + petitionerString + '\'' +
                ", respondentString='" + respondentString + '\'' +
                ", petitionerlawerString='" + petitionerlawerString + '\'' +
                ", respondentlawerString='" + respondentlawerString + '\'' +
                ", path='" + path + '\'' +
                ...
                ", originalPetitioners='" + originalPetitioners + '\'' +
                ", originalRespondents='" + originalRespondents + '\'' +
                ", originalPetitionerlawers='" + originalPetitionerlawers + '\'' +
                ", originalRespondentlawers='" + originalRespondentlawers + '\'' +
    ...
    private String petitioners = null;
    private String respondents = null;
    private String petitionerlawers = null;
    private String respondentlawers = null;
    //private List<LayoutToken> authorsTokens = new ArrayList<>();
    private String firstAuthorSurname = null;
    private String firstPetitionerSurname = null;
    private String firstRespondentSurname = null;
    private String firstPetitionerlawerSurname = null;
    private String firstRespondentlawerSurname = null;
    ...
    private List<String> petitionerlawerList;
    private List<String> respondentlawerList;
    ...
    private List<Person> fullPetitioners = null;
    private List<Person> fullRespondents = null;
    private List<Person> fullPetitionerlawers = null;
    private List<Person> fullRespondentlawers = null;
    ...
    private String petitionerString = null;
    private String respondentString = null;
    private String petitionerlawerString = null;
    private String respondentlawerString = null;
    private String path = "";
    ...
    private String originalPetitioners = null;
    private String originalRespondents = null;
    private String originalPetitionerlawers = null;
    private String originalRespondentlawers = null;
    ...
    public String getPetitionerlawers() {
        return petitionerlawers;
    }

    public String getRespondentlawers() {
        return respondentlawers;
    }
    ...
    public String getPetitionerString() {
        return petitionerString;
    }
    public String getRespondentString() {
        return respondentString;
    }
    public String getPetitionerlawerString() {
        return petitionerlawerString;
    }
    public String getRespondentlawerString() {
        return respondentlawerString;
    }
    ...
    public String getOriginalPetitioners() {
        return originalPetitioners;
    }

    public String getOriginalRespondents() {
        return originalRespondents;
    }

    public String getOriginalPetitionerlawers() {
        return originalPetitionerlawers;
    }

    public String getOriginalRespondentlawers() {
        return originalRespondentlawers;
    }
    ...
    public List<org.grobid.core.data.Person> getFullPetitioners() {
        return fullPetitioners;
    }

    public List<org.grobid.core.data.Person> getFullRespondents() {
        return fullRespondents;
    }

    public List<org.grobid.core.data.Person> getFullPetitionerlawers() {
        return fullPetitionerlawers;
    }

    public List<org.grobid.core.data.Person> getFullRespondentlawers() {
        return fullRespondentlawers;
    }
    ...
    public void setPetitionerString(String s) {
        petitionerString = s;
    }

    public void setRespondentString(String s) {
        respondentString = s;
    }

    public void setPetitionerlawerString(String s) {
        petitionerlawerString = s;
    }

    public void setRespondentlawerString(String s) {
        respondentlawerString = s;
    }
    ...
    public void setFullPetitioners(List<org.grobid.core.data.Person> full) {
        fullPetitioners = full;
    }
    public void setFullRespondents(List<org.grobid.core.data.Person> full) {
        fullRespondents = full;
    }
    public void setFullPetitionerlawers(List<org.grobid.core.data.Person> full) {
        fullPetitionerlawers = full;
    }
    public void setFullRespondentlawers(List<org.grobid.core.data.Person> full) {
        fullRespondentlawers = full;
    }
    ...
    public void setPetitioners(String aut) {
        petitioners = aut;
    }

    public void setRespondents(String aut) {
        respondents = aut;
    }

    public void setPetitionerlawers(String aut) {
        petitionerlawers = aut;
    }

    public void setRespondentlawers(String aut) {
        respondentlawers = aut;
    }
    ...
    public BiblioItem collectPetitionersToken(LayoutToken lt) {
        petitionersTokensWorkingCopy.add(lt);
        return this;
    }
    public BiblioItem collectRespondentsToken(LayoutToken lt) {
        respondentsTokensWorkingCopy.add(lt);
        return this;
    }
    public BiblioItem collectPetitionerlawersToken(LayoutToken lt) {
        petitionerlawersTokensWorkingCopy.add(lt);
        return this;
    }
    public BiblioItem collectRespondentlawersToken(LayoutToken lt) {
        respondentlawersTokensWorkingCopy.add(lt);
        return this;
    }
    ...
    public void collectPetitionersTokens(List<LayoutToken> layoutTokens) {
        this.petitionersTokensWorkingCopy.addAll(layoutTokens);
    }

    public void collectRespondentsTokens(List<LayoutToken> layoutTokens) {
        this.respondentsTokensWorkingCopy.addAll(layoutTokens);
    }

    public void collectPetitionerlawersTokens(List<LayoutToken> layoutTokens) {
        this.petitionerlawersTokensWorkingCopy.addAll(layoutTokens);
    }

    public void collectRespondentlawersTokens(List<LayoutToken> layoutTokens) {
        this.respondentlawersTokensWorkingCopy.addAll(layoutTokens);
    }
    ...
    public void addPetitioner(String aut) {
        if (petitioners == null)
            petitioners = aut;
        else
            petitioners += " ; " + aut;

        if (petitionerList == null)
            petitionerList = new ArrayList<String>();
        if (!petitionerList.contains(aut))
            petitionerList.add(aut);
    }

    public void addRespondent(String aut) {
        if (respondents == null)
            respondents = aut;
        else
            respondents += " ; " + aut;
        ...
        if (respondentList == null)
            respondentList = new ArrayList<String>();
        if (!respondentList.contains(aut))
            respondentList.add(aut);
    }
    public void addPetitionerlawer(String aut) {
        if (petitionerlawers == null)
            petitionerlawers = aut;
        else
            petitionerlawers += " ; " + aut;

        if (petitionerlawerList == null)
            petitionerlawerList = new ArrayList<String>();
        if (!petitionerlawerList.contains(aut))
            petitionerlawerList.add(aut);
    }
    public void addRespondentlawer(String aut) {
        if (respondentlawers == null)
            respondentlawers = aut;
        else
            respondentlawers += " ; " + aut;

        if (respondentlawerList == null)
            respondentlawerList = new ArrayList<String>();
        if (!respondentlawerList.contains(aut))
            respondentlawerList.add(aut);
    }
    ...
    public void addFullPetitioner(Person aut) {
        if (fullPetitioners == null)
            fullPetitioners = new ArrayList<Person>();
        if (!fullPetitioners.contains(aut))
            fullPetitioners.add(aut);
    }

    public void addFullRespondent(Person aut) {
        if (fullRespondents == null)
            fullRespondents = new ArrayList<Person>();
        if (!fullRespondents.contains(aut))
            fullRespondents.add(aut);
    }

    public void addFullPetitionerlawer(Person aut) {
        if (fullPetitionerlawers == null)
            fullPetitionerlawers = new ArrayList<Person>();
        if (!fullPetitionerlawers.contains(aut))
            fullPetitionerlawers.add(aut);
    }

    public void addFullRespondentlawer(Person aut) {
        if (fullRespondentlawers == null)
            fullRespondentlawers = new ArrayList<Person>();
        if (!fullRespondentlawers.contains(aut))
            fullRespondentlawers.add(aut);
    }
    ...
    public void setCasenumber(String k) {
        casenumber = k;
    }
    ...
    public void addCasenumber(String k) {
        if (casenumbers == null)
            casenumbers = new ArrayList<Casenumber>();
		
		if (k != null) {
        	casenumbers.add(new Casenumber(k));
		}
    }
    ...
    public void setOriginalPetitioners(String original) {
        originalPetitioners = original;
    }

    public void setOriginalRespondents(String original) {
        originalRespondents = original;
    }

    public void setOriginalPetitionerlawers(String original) {
        originalPetitionerlawers = original;
    }

    public void setOriginalRespondentlawers(String original) {
        originalRespondentlawers = original;
    }
    ...
    public void setOriginalCasenumber(String original) {
    ...
    public void reset() {
        ...
        petitioners = null;
        respondents = null;
        petitionerlawers = null;
        respondentlawers = null;
        location = null;
        bookTitle = null;
        pageRange = null;
        journal = null;
        ...
        fullAuthors = null;
        fullPetitioners = null;
        fullRespondents = null;
        fullPetitionerlawers = null;
        fullRespondentlawers = null;
    ...
    public static List<Casenumber> segmentCasenumbers(String string) {
        if (string == null)
            return null;
        if (string.length() == 0)
            return null;
		...
		List<Casenumber> result = new ArrayList<Casenumber>();
		// the list of possible casenumber separators
		List<String> separators = Arrays.asList(";","•", "ㆍ", "Á", "\n", ",", ".", ":", "/", "|");
		for(String separator : separators) {
	        StringTokenizer st = new StringTokenizer(string, separator);
	        if (st.countTokens() > 2) {
    ...
    public String toBibTeX(String id, GrobidAnalysisConfig config) {
        ...
        try {
            ...
            //petitioner
            if (collaboration != null) {
                bibtex.add(" petitioner = {" + collaboration +"}");
            } else {
                StringJoiner petitioners = new StringJoiner(" and ", "  petitioner = {", "}");
                if (fullPetitioners != null) {
                    fullPetitioners.stream()
                                .filter(person -> person != null)
                                .forEachOrdered(person -> {
                                    String petitioner = "";
                                    if (person.getLastName() != null) {
                                        petitioner = person.getLastName();
                                    }
                                    if (person.getFirstName() != null) {
                                        if (petitioner.length() > 0) {
                                            petitioner += ", ";
                                        }
                                        petitioner += person.getFirstName();
                                    }
                                    if (petitioner.length() > 0 ) {
                                        petitioners.add(petitioner);
                                    }
                                });
                } else if (this.petitioners != null) {
                    StringTokenizer st = new StringTokenizer(this.petitioners, ";");
                    while (st.hasMoreTokens()) {
                        String petitioner = st.nextToken();
                        if (petitioner != null) {
                            petitioners.add(petitioner.trim());
                        }
                    }
                }
                bibtex.add(petitioners.toString());    
            }

            //respondent
            if (collaboration != null) {
                bibtex.add(" respondent = {" + collaboration +"}");
            } else {
                StringJoiner respondents = new StringJoiner(" and ", "  respondent = {", "}");
                if (fullRespondents != null) {
                    fullRespondents.stream()
                                .filter(person -> person != null)
                                .forEachOrdered(person -> {
                                    String respondent = "";
                                    if (person.getLastName() != null) {
                                        respondent = person.getLastName();
                                    }
                                    if (person.getFirstName() != null) {
                                        if (respondent.length() > 0) {
                                            respondent += ", ";
                                        }
                                        respondent += person.getFirstName();
                                    }
                                    if (respondent.length() > 0 ) {
                                        respondents.add(respondent);
                                    }
                                });
                } else if (this.respondents != null) {
                    StringTokenizer st = new StringTokenizer(this.respondents, ";");
                    while (st.hasMoreTokens()) {
                        String respondent = st.nextToken();
                        if (respondent != null) {
                            respondents.add(respondent.trim());
                        }
                    }
                }
                bibtex.add(respondents.toString());
            }

            //petitionerlawer
            if (collaboration != null) {
                bibtex.add(" petitioner_lawer = {" + collaboration +"}");
            } else {
                StringJoiner petitionerlawers = new StringJoiner(" and ", "  petitioner_lawer = {", "}");
                if (fullPetitionerlawers != null) {
                    fullPetitionerlawers.stream()
                                .filter(person -> person != null)
                                .forEachOrdered(person -> {
                                    String petitionerlawer = "";
                                    if (person.getLastName() != null) {
                                        petitionerlawer = person.getLastName();
                                    }
                                    if (person.getFirstName() != null) {
                                        if (petitionerlawer.length() > 0) {
                                            petitionerlawer += ", ";
                                        }
                                        petitionerlawer += person.getFirstName();
                                    }
                                    if (petitionerlawer.length() > 0 ) {
                                        petitionerlawers.add(petitionerlawer);
                                    }
                                });
                } else if (this.petitionerlawers != null) {
                    StringTokenizer st = new StringTokenizer(this.petitionerlawers, ";");
                    while (st.hasMoreTokens()) {
                        String petitionerlawer = st.nextToken();
                        if (petitionerlawer != null) {
                            petitionerlawers.add(petitionerlawer.trim());
                        }
                    }
                }
                bibtex.add(petitionerlawers.toString());        
            }
            ...
            if (collaboration != null) {
                ...
                StringJoiner respondentlawers = new StringJoiner(" and ", "  respondent_lawer = {", "}");
                if (fullRespondentlawers != null) {
                    fullRespondentlawers.stream()
                                .filter(person -> person != null)
                                .forEachOrdered(person -> {
                                    String respondentlawer = "";
                                    if (person.getLastName() != null) {
                                        respondentlawer = person.getLastName();
                                    }
                                    if (person.getFirstName() != null) {
                                        if (respondentlawer.length() > 0) {
                                            respondentlawer += ", ";
                                        }
                                        respondentlawer += person.getFirstName();
                                    }
                                    if (respondentlawer.length() > 0 ) {
                                        respondentlawers.add(respondentlawer);
                                    }
                                });
                } else if (this.respondentlawers != null) {
                    StringTokenizer st = new StringTokenizer(this.respondentlawers, ";");
                    while (st.hasMoreTokens()) {
                        String respondentlawer = st.nextToken();
                        if (respondentlawer != null) {
                            respondentlawers.add(respondentlawer.trim());
                        }
                    }
                }
                bibtex.add(respondentlawers.toString());
            }
            ...
            */
            ...
            // casenumbers
            if (casenumbers != null) {
                String cases = casenumbers.stream()
                        .map(casenumber -> casenumber.getCasenumber())
    ...
    public String toTEI(int n, int indent, GrobidAnalysisConfig config) {
        ...
        try {
            ...
            tei.append(toTEIPetitionerBlock(2, config));
            tei.append(toTEIRespondentBlock(2, config));
            tei.append(toTEIPetitionerlawerBlock(2, config));
            tei.append(toTEIRespondentlawerBlock(2, config));
            ...
            // casenumbers here !!
            if (!StringUtils.isEmpty(getCasenumber())) {
    ...
    public void setFirstPetitionerSurname(String firstPetitionerSurname) {
        this.firstPetitionerSurname = firstPetitionerSurname;
    }

    public void setFirstRespondentSurname(String firstRespondentSurname) {
        this.firstRespondentSurname = firstRespondentSurname;
    }

    public void setFirstPetitionerlawerSurname(String firstPetitionerlawerSurname) {
        this.firstPetitionerlawerSurname = firstPetitionerlawerSurname;
    }

    public void setFirstRespondentlawerSurname(String firstRespondentlawerSurname) {
        this.firstRespondentlawerSurname = firstRespondentlawerSurname;
    }
    ...
    public String getFirstPetitionerSurname() {
        if (this.firstPetitionerSurname != null) {
            return this.firstPetitionerSurname;
            //return TextUtilities.HTMLEncode(this.firstAuthorSurname);
        }

        if (fullPetitioners != null) {
            if (fullPetitioners.size() > 0) {
                Person pet = fullPetitioners.get(0);
                String sur = pet.getLastName();
                if (sur != null) {
                    if (sur.length() > 0) {
                        this.firstPetitionerSurname = sur;
                        //return TextUtilities.HTMLEncode(sur);
                        return sur;
                    }
                }
        ...
        if (petitioners != null) {
            StringTokenizer st = new StringTokenizer(petitioners, ";");
            if (st.countTokens() > 0) {
                if (st.hasMoreTokens()) { // we take just the first author
                    String petitioner = st.nextToken();
                    if (petitioner != null)
                        petitioner = petitioner.trim();
                    int ind = petitioner.lastIndexOf(" ");
                    if (ind != -1) {
                        this.firstPetitionerSurname = petitioner.substring(ind + 1);
                        //return TextUtilities.HTMLEncode(author.substring(ind + 1));
                        return petitioner.substring(ind + 1);
                    } else {
                        this.firstPetitionerSurname = petitioner;
                        //return TextUtilities.HTMLEncode(author);
                        return petitioner;
                    }
                }
    ...
    public String getFirstRespondentSurname() {
        if (this.firstRespondentSurname != null) {
            return this.firstRespondentSurname;
            //return TextUtilities.HTMLEncode(this.firstAuthorSurname);
        }

        if (fullRespondents != null) {
            if (fullRespondents.size() > 0) {
                Person resp = fullRespondents.get(0);
                String sur = resp.getLastName();
                if (sur != null) {
                    if (sur.length() > 0) {
                        this.firstRespondentSurname = sur;
                        //return TextUtilities.HTMLEncode(sur);
                        return sur;
                    }
                }
        ...
        if (respondents != null) {
            StringTokenizer st = new StringTokenizer(respondents, ";");
            if (st.countTokens() > 0) {
                if (st.hasMoreTokens()) { // we take just the first author
                    String respondent = st.nextToken();
                    if (respondent != null)
                        respondent = respondent.trim();
                    int ind = respondent.lastIndexOf(" ");
                    if (ind != -1) {
                        this.firstRespondentSurname = respondent.substring(ind + 1);
                        //return TextUtilities.HTMLEncode(author.substring(ind + 1));
                        return respondent.substring(ind + 1);
                    } else {
                        this.firstRespondentSurname = respondent;
                        //return TextUtilities.HTMLEncode(author);
                        return respondent;
                    }
                }
    ...
    public String getFirstPetitionerlawerSurname() {
        if (this.firstPetitionerlawerSurname != null) {
            return this.firstPetitionerlawerSurname;
            //return TextUtilities.HTMLEncode(this.firstAuthorSurname);
        }

        if (fullPetitionerlawers != null) {
            if (fullPetitionerlawers.size() > 0) {
                Person petl = fullPetitionerlawers.get(0);
                String sur = petl.getLastName();
                if (sur != null) {
                    if (sur.length() > 0) {
                        this.firstPetitionerlawerSurname = sur;
                        //return TextUtilities.HTMLEncode(sur);
                        return sur;
                    }
                }
        ...
        if (petitionerlawers != null) {
            StringTokenizer st = new StringTokenizer(petitionerlawers, ";");
            if (st.countTokens() > 0) {
                if (st.hasMoreTokens()) { // we take just the first author
                    String petitionerlawer = st.nextToken();
                    if (petitionerlawer != null)
                        petitionerlawer = petitionerlawer.trim();
                    int ind = petitionerlawer.lastIndexOf(" ");
                    if (ind != -1) {
                        this.firstPetitionerlawerSurname = petitionerlawer.substring(ind + 1);
                        //return TextUtilities.HTMLEncode(author.substring(ind + 1));
                        return petitionerlawer.substring(ind + 1);
                    } else {
                        this.firstPetitionerlawerSurname = petitionerlawer;
                        //return TextUtilities.HTMLEncode(author);
                        return petitionerlawer;
                    }
                }
            }
    ...
    public String getFirstRespondentlawerSurname() {
        if (this.firstRespondentlawerSurname != null) {
            return this.firstRespondentlawerSurname;
            //return TextUtilities.HTMLEncode(this.firstAuthorSurname);
        }

        if (fullRespondentlawers != null) {
            if (fullRespondentlawers.size() > 0) {
                Person respl = fullRespondentlawers.get(0);
                String sur = respl.getLastName();
                if (sur != null) {
                    if (sur.length() > 0) {
                        this.firstRespondentlawerSurname = sur;
                        //return TextUtilities.HTMLEncode(sur);
                        return sur;
                    }
                }
        ...
        if (respondentlawers != null) {
            StringTokenizer st = new StringTokenizer(respondentlawers, ";");
            if (st.countTokens() > 0) {
                if (st.hasMoreTokens()) { // we take just the first author
                    String respondentlawer = st.nextToken();
                    if (respondentlawer != null)
                        respondentlawer = respondentlawer.trim();
                    int ind = respondentlawer.lastIndexOf(" ");
                    if (ind != -1) {
                        this.firstRespondentlawerSurname = respondentlawer.substring(ind + 1);
                        //return TextUtilities.HTMLEncode(author.substring(ind + 1));
                        return respondentlawer.substring(ind + 1);
                    } else {
                        this.firstRespondentlawerSurname = respondentlawer;
                        //return TextUtilities.HTMLEncode(author);
                        return respondentlawer;
                    }
                }
            }
    ...
    public void attachEmailsP() {
        attachEmailsP(fullPetitioners);
    }
    public void attachEmailsR() {
        attachEmailsR(fullRespondents);
    }
    public void attachEmailsPL() {
        attachEmailsPL(fullPetitionerlawers);
    }
    public void attachEmailsRL() {
        attachEmailsRL(fullRespondentlawers);
    }
    ...
    public void attachEmailsP(List<Person> folks) {
        // do we have an email field recognized? 
        if (email == null)
            return;
        // we check if we have several emails in the field
        ...
        if (sanitizedEmails != null) {
            petitionerEmailAssigner.assign(folks, sanitizedEmails);
        }
    }
    public void attachEmailsR(List<Person> folks) {
        // do we have an email field recognized? 
        if (email == null)
            return;
        // we check if we have several emails in the field
        ...
        if (sanitizedEmails != null) {
            respondentEmailAssigner.assign(folks, sanitizedEmails);
        }
    }
    public void attachEmailsPL(List<Person> folks) {
        // do we have an email field recognized? 
        if (email == null)
            return;
        // we check if we have several emails in the field
        ...
        if (sanitizedEmails != null) {
            petitionerlawerEmailAssigner.assign(folks, sanitizedEmails);
        }
    }
    public void attachEmailsRL(List<Person> folks) {
        // do we have an email field recognized? 
        if (email == null)
            return;
        // we check if we have several emails in the field
        ...
        if (sanitizedEmails != null) {
            respondentlawerEmailAssigner.assign(folks, sanitizedEmails);
        }
    }
    ...
    public void attachPetitionerEmails() {
        attachEmailsP(fullPetitioners);
    }

    public void attachRespondentEmails() {
        attachEmailsR(fullRespondents);
    }

    public void attachPetitionerlawerEmails() {
        attachEmailsPL(fullPetitionerlawers);
    }

    public void attachRespondentlawerEmails() {
        attachEmailsRL(fullRespondentlawers);
    }
    ...
    public void attachAffiliationsP() {
        if (fullAffiliations == null) {
            return;
        }
        ...
        int nbAffiliations = fullAffiliations.size();
        int nbPetitioners = fullPetitioners.size();
        ...
        if (nbAffiliations == 1) {
            // we distribute this affiliation to each Petitioner
            Affiliation aff = fullAffiliations.get(0);
            for (Person aut : fullPetitioners) {
                aut.addAffiliation(aff);
            }
            aff.setFailAffiliation(false);
        } else if ((nbPetitioners == 1) && (nbAffiliations > 1)) {
            // we put all the affiliations to the single Petitioner
            Person auth = fullPetitioners.get(0);
            for (Affiliation aff : fullAffiliations) {
                auth.addAffiliation(aff);
                aff.setFailAffiliation(false);
            }
        } else if (hasMarker) {
            // we get the marker for each affiliation and try to find the related Petitioner in the
            // original Petitioner field
            for (Affiliation aff : fullAffiliations) {
                if (aff.getMarker() != null) {
                    String marker = aff.getMarker();
                    int from = 0;
                    ...
                    ArrayList<Integer> winners = new ArrayList<Integer>();
                    while (ind != -1) {
                        ind = originalPetitioners.indexOf(marker, from);
                        boolean bad = false;
                        if (ind != -1) {
                            // we check if we have a digit/letter (1) matching incorrectly
                            //  a double digit/letter (11), or a special non-digit (*) matching incorrectly
                            ...
                            if (marker.length() == 1) {
                                if (Character.isDigit(marker.charAt(0))) {
                                    if (ind - 1 > 0) {
                                        if (Character.isDigit(originalPetitioners.charAt(ind - 1))) {
                                            bad = true;
                                        }
                                    }
                                    if (ind + 1 < originalPetitioners.length()) {
                                        if (Character.isDigit(originalPetitioners.charAt(ind + 1))) {
                                            bad = true;
                                        }
                                    }
                                    ...
                                    if (ind - 1 > 0) {
                                        if (Character.isLetter(originalPetitioners.charAt(ind - 1))) {
                                            bad = true;
                                        }
                                    }
                                    if (ind + 1 < originalPetitioners.length()) {
                                    ...
                                    if (ind - 1 > 0) {
                                        if (originalPetitioners.charAt(ind - 1) == '*') {
                                            bad = true;
                                        }
                                    }
                                    if (ind + 1 < originalPetitioners.length()) {
                            ...
                            if (marker.length() == 2) {
                                ...
                                if ((marker.charAt(0) == '*') && (marker.charAt(1) == '*')) {
                                    if (ind - 2 > 0) {
                                        if ((originalPetitioners.charAt(ind - 1) == '*') &&
                                                (originalPetitioners.charAt(ind - 2) == '*')) {
                                            bad = true;
                                        }
                                    }
                                    if (ind + 2 < originalPetitioners.length()) {
                                        if ((originalPetitioners.charAt(ind + 1) == '*') &&
                                                (originalPetitioners.charAt(ind + 2) == '*')) {
                                            bad = true;
                                        }
                                    }
                                    if ((ind - 1 > 0) && (ind + 1 < originalPetitioners.length())) {
                                        if ((originalPetitioners.charAt(ind - 1) == '*') &&
                                                (originalPetitioners.charAt(ind + 1) == '*')) {
                                            bad = true;
                                        }
                                    }
                                }
                        ...
                        if ((ind != -1) && !bad) {
                            // we find the associated Petitioner name 
                            String original = originalPetitioners.toLowerCase();
                            int p = 0;
                            int best = -1;
                            int ind2 = -1;
                            int bestDistance = 1000;
                            ...
                            // and we associate this affiliation to this Petitioner
                            if (best != -1) {
                                fullPetitioners.get(best).addAffiliation(aff);
                                aff.setFailAffiliation(false);
                                winners.add(Integer.valueOf(best));
                            }
        ...
        } /*else if (nbPetitioners == nbAffiliations) {
            // risky heuristics, we distribute in this case one affiliation per Petitioner
            // preserving Petitioner 
            // sometimes 2 affiliations belong both to 2 Petitioners, for these case, the layout
            // positioning should be studied
            for (int p = 0; p < nbPetitioners; p++) {
                fullPetitioners.get(p).addAffiliation(fullAffiliations.get(p));
                System.out.println("attachment: " + p);
                System.out.println(fullPetitioners.get(p));
                fullAffiliations.get(p).setFailAffiliation(false);
            }
        }*/
    }
    
    public void attachAffiliationsR() {
        if (fullAffiliations == null) {
            return;
        }
        ...
        int nbAffiliations = fullAffiliations.size();
        int nbRespondents = fullRespondents.size();
        ...
        if (nbAffiliations == 1) {
            // we distribute this affiliation to each Respondent
            Affiliation aff = fullAffiliations.get(0);
            for (Person aut : fullRespondents) {
                aut.addAffiliation(aff);
            }
            aff.setFailAffiliation(false);
        } else if ((nbRespondents == 1) && (nbAffiliations > 1)) {
            // we put all the affiliations to the single Respondent
            Person auth = fullRespondents.get(0);
            for (Affiliation aff : fullAffiliations) {
                auth.addAffiliation(aff);
                aff.setFailAffiliation(false);
            }
        } else if (hasMarker) {
            // we get the marker for each affiliation and try to find the related Respondent in the
            // original Respondent field
            for (Affiliation aff : fullAffiliations) {
                if (aff.getMarker() != null) {
                    String marker = aff.getMarker();
                    int from = 0;
                    ...
                    ArrayList<Integer> winners = new ArrayList<Integer>();
                    while (ind != -1) {
                        ind = originalRespondents.indexOf(marker, from);
                        boolean bad = false;
                        if (ind != -1) {
                            // we check if we have a digit/letter (1) matching incorrectly
                            //  a double digit/letter (11), or a special non-digit (*) matching incorrectly
                            ...
                            if (marker.length() == 1) {
                                if (Character.isDigit(marker.charAt(0))) {
                                    if (ind - 1 > 0) {
                                        if (Character.isDigit(originalRespondents.charAt(ind - 1))) {
                                            bad = true;
                                        }
                                    }
                                    if (ind + 1 < originalRespondents.length()) {
                                        if (Character.isDigit(originalRespondents.charAt(ind + 1))) {
                                            bad = true;
                                        }
                                    }
                                    ...
                                    if (ind - 1 > 0) {
                                        if (Character.isLetter(originalRespondents.charAt(ind - 1))) {
                                            bad = true;
                                        }
                                    }
                                    if (ind + 1 < originalRespondents.length()) {
                                    ...
                                    if (ind - 1 > 0) {
                                        if (originalRespondents.charAt(ind - 1) == '*') {
                                            bad = true;
                                        }
                                    }
                                    if (ind + 1 < originalRespondents.length()) {
                            ...
                            if (marker.length() == 2) {
                                ...
                                if ((marker.charAt(0) == '*') && (marker.charAt(1) == '*')) {
                                    if (ind - 2 > 0) {
                                        if ((originalRespondents.charAt(ind - 1) == '*') &&
                                                (originalRespondents.charAt(ind - 2) == '*')) {
                                            bad = true;
                                        }
                                    }
                                    if (ind + 2 < originalRespondents.length()) {
                                        if ((originalRespondents.charAt(ind + 1) == '*') &&
                                                (originalRespondents.charAt(ind + 2) == '*')) {
                                            bad = true;
                                        }
                                    }
                                    if ((ind - 1 > 0) && (ind + 1 < originalRespondents.length())) {
                                        if ((originalRespondents.charAt(ind - 1) == '*') &&
                                                (originalRespondents.charAt(ind + 1) == '*')) {
                                            bad = true;
                                        }
                                    }
                                }
                        ...
                        if ((ind != -1) && !bad) {
                            // we find the associated Respondent name 
                            String original = originalRespondents.toLowerCase();
                            int p = 0;
                            int best = -1;
                            int ind2 = -1;
                            int bestDistance = 1000;
                            ...
                            // and we associate this affiliation to this Respondent
                            if (best != -1) {
                                fullRespondents.get(best).addAffiliation(aff);
                                aff.setFailAffiliation(false);
                                winners.add(Integer.valueOf(best));
                            }
        ...
        } /*else if (nbRespondents == nbAffiliations) {
            // risky heuristics, we distribute in this case one affiliation per Respondent
            // preserving Respondent 
            // sometimes 2 affiliations belong both to 2 Respondents, for these case, the layout
            // positioning should be studied
            for (int p = 0; p < nbRespondents; p++) {
                fullRespondents.get(p).addAffiliation(fullAffiliations.get(p));
                System.out.println("attachment: " + p);
                System.out.println(fullRespondents.get(p));
                fullAffiliations.get(p).setFailAffiliation(false);
            }
        }*/
    }
    public void attachAffiliationsPL() {
        if (fullAffiliations == null) {
            return;
        }
        ...
        int nbAffiliations = fullAffiliations.size();
        int nbPetitionerlawers = fullPetitionerlawers.size();
        ...
        if (nbAffiliations == 1) {
            // we distribute this affiliation to each Petitionerlawer
            Affiliation aff = fullAffiliations.get(0);
            for (Person aut : fullPetitionerlawers) {
                aut.addAffiliation(aff);
            }
            aff.setFailAffiliation(false);
        } else if ((nbPetitionerlawers == 1) && (nbAffiliations > 1)) {
            // we put all the affiliations to the single Petitionerlawer
            Person auth = fullPetitionerlawers.get(0);
            for (Affiliation aff : fullAffiliations) {
                auth.addAffiliation(aff);
                aff.setFailAffiliation(false);
            }
        } else if (hasMarker) {
            // we get the marker for each affiliation and try to find the related Petitionerlawer in the
            // original Petitionerlawer field
            for (Affiliation aff : fullAffiliations) {
                if (aff.getMarker() != null) {
                    String marker = aff.getMarker();
                    int from = 0;
                    ...
                    ArrayList<Integer> winners = new ArrayList<Integer>();
                    while (ind != -1) {
                        ind = originalPetitionerlawers.indexOf(marker, from);
                        boolean bad = false;
                        if (ind != -1) {
                            // we check if we have a digit/letter (1) matching incorrectly
                            //  a double digit/letter (11), or a special non-digit (*) matching incorrectly
                            ...
                            if (marker.length() == 1) {
                                if (Character.isDigit(marker.charAt(0))) {
                                    if (ind - 1 > 0) {
                                        if (Character.isDigit(originalPetitionerlawers.charAt(ind - 1))) {
                                            bad = true;
                                        }
                                    }
                                    if (ind + 1 < originalPetitionerlawers.length()) {
                                        if (Character.isDigit(originalPetitionerlawers.charAt(ind + 1))) {
                                            bad = true;
                                        }
                                    }
                                    ...
                                    if (ind - 1 > 0) {
                                        if (Character.isLetter(originalPetitionerlawers.charAt(ind - 1))) {
                                            bad = true;
                                        }
                                    }
                                    if (ind + 1 < originalPetitionerlawers.length()) {
                                    ...
                                    if (ind - 1 > 0) {
                                        if (originalPetitionerlawers.charAt(ind - 1) == '*') {
                                            bad = true;
                                        }
                                    }
                                    if (ind + 1 < originalPetitionerlawers.length()) {
                            ...
                            if (marker.length() == 2) {
                                ...
                                if ((marker.charAt(0) == '*') && (marker.charAt(1) == '*')) {
                                    if (ind - 2 > 0) {
                                        if ((originalPetitionerlawers.charAt(ind - 1) == '*') &&
                                                (originalPetitionerlawers.charAt(ind - 2) == '*')) {
                                            bad = true;
                                        }
                                    }
                                    if (ind + 2 < originalPetitionerlawers.length()) {
                                        if ((originalPetitionerlawers.charAt(ind + 1) == '*') &&
                                                (originalPetitionerlawers.charAt(ind + 2) == '*')) {
                                            bad = true;
                                        }
                                    }
                                    if ((ind - 1 > 0) && (ind + 1 < originalPetitionerlawers.length())) {
                                        if ((originalPetitionerlawers.charAt(ind - 1) == '*') &&
                                                (originalPetitionerlawers.charAt(ind + 1) == '*')) {
                                            bad = true;
                                        }
                                    }
                                }
                        ...
                        if ((ind != -1) && !bad) {
                            // we find the associated Petitionerlawer name 
                            String original = originalPetitionerlawers.toLowerCase();
                            int p = 0;
                            int best = -1;
                            int ind2 = -1;
                            int bestDistance = 1000;
                            ...
                            // and we associate this affiliation to this Petitionerlawer
                            if (best != -1) {
                                fullPetitionerlawers.get(best).addAffiliation(aff);
                                aff.setFailAffiliation(false);
                                winners.add(Integer.valueOf(best));
                            }
        ...
        } /*else if (nbPetitionerlawers == nbAffiliations) {
            // risky heuristics, we distribute in this case one affiliation per Petitionerlawer
            // preserving Petitionerlawer 
            // sometimes 2 affiliations belong both to 2 Petitionerlawers, for these case, the layout
            // positioning should be studied
            for (int p = 0; p < nbPetitionerlawers; p++) {
                fullPetitionerlawers.get(p).addAffiliation(fullAffiliations.get(p));
                System.out.println("attachment: " + p);
                System.out.println(fullPetitionerlawers.get(p));
                fullAffiliations.get(p).setFailAffiliation(false);
            }
        }*/
    }

    public void attachAffiliationsRL() {
        if (fullAffiliations == null) {
            return;
        }
        ...
        int nbAffiliations = fullAffiliations.size();
        int nbRespondentlawers = fullRespondentlawers.size();
        ...
        if (nbAffiliations == 1) {
            // we distribute this affiliation to each Respondentlawer
            Affiliation aff = fullAffiliations.get(0);
            for (Person aut : fullRespondentlawers) {
                aut.addAffiliation(aff);
            }
            aff.setFailAffiliation(false);
        } else if ((nbRespondentlawers == 1) && (nbAffiliations > 1)) {
            // we put all the affiliations to the single Respondentlawer
            Person auth = fullRespondentlawers.get(0);
            for (Affiliation aff : fullAffiliations) {
                auth.addAffiliation(aff);
                aff.setFailAffiliation(false);
            }
        } else if (hasMarker) {
            // we get the marker for each affiliation and try to find the related Respondentlawer in the
            // original Respondentlawer field
            for (Affiliation aff : fullAffiliations) {
                if (aff.getMarker() != null) {
                    String marker = aff.getMarker();
                    int from = 0;
                    ...
                    ArrayList<Integer> winners = new ArrayList<Integer>();
                    while (ind != -1) {
                        ind = originalRespondentlawers.indexOf(marker, from);
                        boolean bad = false;
                        if (ind != -1) {
                            // we check if we have a digit/letter (1) matching incorrectly
                            //  a double digit/letter (11), or a special non-digit (*) matching incorrectly
                            ...
                            if (marker.length() == 1) {
                                if (Character.isDigit(marker.charAt(0))) {
                                    if (ind - 1 > 0) {
                                        if (Character.isDigit(originalRespondentlawers.charAt(ind - 1))) {
                                            bad = true;
                                        }
                                    }
                                    if (ind + 1 < originalRespondentlawers.length()) {
                                        if (Character.isDigit(originalRespondentlawers.charAt(ind + 1))) {
                                            bad = true;
                                        }
                                    }
                                    ...
                                    if (ind - 1 > 0) {
                                        if (Character.isLetter(originalRespondentlawers.charAt(ind - 1))) {
                                            bad = true;
                                        }
                                    }
                                    if (ind + 1 < originalRespondentlawers.length()) {
                                    ...
                                    if (ind - 1 > 0) {
                                        if (originalRespondentlawers.charAt(ind - 1) == '*') {
                                            bad = true;
                                        }
                                    }
                                    if (ind + 1 < originalRespondentlawers.length()) {
                            ...
                            if (marker.length() == 2) {
                                ...
                                if ((marker.charAt(0) == '*') && (marker.charAt(1) == '*')) {
                                    if (ind - 2 > 0) {
                                        if ((originalRespondentlawers.charAt(ind - 1) == '*') &&
                                                (originalRespondentlawers.charAt(ind - 2) == '*')) {
                                            bad = true;
                                        }
                                    }
                                    if (ind + 2 < originalRespondentlawers.length()) {
                                        if ((originalRespondentlawers.charAt(ind + 1) == '*') &&
                                                (originalRespondentlawers.charAt(ind + 2) == '*')) {
                                            bad = true;
                                        }
                                    }
                                    if ((ind - 1 > 0) && (ind + 1 < originalRespondentlawers.length())) {
                                        if ((originalRespondentlawers.charAt(ind - 1) == '*') &&
                                                (originalRespondentlawers.charAt(ind + 1) == '*')) {
                                            bad = true;
                                        }
                                    }
                                }
                        ...
                        if ((ind != -1) && !bad) {
                            // we find the associated Respondentlawer name 
                            String original = originalRespondentlawers.toLowerCase();
                            int p = 0;
                            int best = -1;
                            int ind2 = -1;
                            int bestDistance = 1000;
                            ...
                            // and we associate this affiliation to this Respondentlawer
                            if (best != -1) {
                                fullRespondentlawers.get(best).addAffiliation(aff);
                                aff.setFailAffiliation(false);
                                winners.add(Integer.valueOf(best));
                            }
        ...
        } /*else if (nbRespondentlawers == nbAffiliations) {
            // risky heuristics, we distribute in this case one affiliation per Respondentlawer
            // preserving Respondentlawer 
            // sometimes 2 affiliations belong both to 2 Respondentlawers, for these case, the layout
            // positioning should be studied
            for (int p = 0; p < nbRespondentlawers; p++) {
                fullRespondentlawers.get(p).addAffiliation(fullAffiliations.get(p));
                System.out.println("attachment: " + p);
                System.out.println(fullRespondentlawers.get(p));
                fullAffiliations.get(p).setFailAffiliation(false);
            }
        }*/
    }
    ...
    public String toTEIPetitionerBlock(int nbTag) {
        return toTEIPetitionerBlock(nbTag, GrobidAnalysisConfig.defaultInstance());
    }

    public String toTEIRespondentBlock(int nbTag) {
        return toTEIRespondentBlock(nbTag, GrobidAnalysisConfig.defaultInstance());
    }

    public String toTEIPetitionerlawerBlock(int nbTag) {
        return toTEIPetitionerlawerBlock(nbTag, GrobidAnalysisConfig.defaultInstance());
    }

    public String toTEIRespondentlawerBlock(int nbTag) {
        return toTEIRespondentlawerBlock(nbTag, GrobidAnalysisConfig.defaultInstance());
    }
    ...
    public String toTEIPetitionerBlock(int nbTag, GrobidAnalysisConfig config) {
        StringBuffer tei = new StringBuffer();
        int nbPetitioners = 0;
        int nbAffiliations = 0;
        int nbAddresses = 0;
        ...
        */
        ...
        List<Person> auts = fullPetitioners;
        ...
        if (auts != null) {
            ...
            if (nbPetitioners > 0) {
                ...
                int contactAut = -1;
                //check if we have a single author of contact
                for (Person petitioner : auts) {
                    if (petitioner.getEmail() != null) {
                        if (contactAut == -1)
                            contactAut = autRank;
                        else {
                            contactAut = -1;
                ...
                autRank = 0;
                for (Person petitioner : auts) {
                    if (petitioner.getLastName() != null) {
                        if (petitioner.getLastName().length() < 2)
                            continue;
                    }

			        if ( (petitioner.getFirstName() == null) && (petitioner.getMiddleName() == null) &&
			                (petitioner.getLastName() == null) ) {
						continue;
					}

                    TextUtilities.appendN(tei, '\t', nbTag);
                    tei.append("<petitioner");
                    ...
                    String localString = petitioner.toTEI(withCoordinates);
                    localString = localString.replace(" xmlns=\"http://www.tei-c.org/ns/1.0\"", "");
                    tei.append(localString).append("\n");
                    if (petitioner.getEmail() != null) {
                        TextUtilities.appendN(tei, '\t', nbTag + 1);
                        tei.append("<email>" + TextUtilities.HTMLEncode(petitioner.getEmail()) + "</email>\n");
                    }
                    if (petitioner.getORCID() != null) {
                        TextUtilities.appendN(tei, '\t', nbTag + 1);
                        tei.append("<idno type=\"ORCID\">" + TextUtilities.HTMLEncode(petitioner.getORCID()) + "</idno>\n");
                    }

                    if (petitioner.getAffiliations() != null) {
                        for (Affiliation aff : petitioner.getAffiliations()) {
                            this.appendAffiliation(tei, nbTag + 1, aff, config, lexicon);
                        }
                    } else if (collaboration != null) {
                        TextUtilities.appendN(tei, '\t', nbTag + 1);
    ...
    public String toTEIRespondentBlock(int nbTag, GrobidAnalysisConfig config) {
        StringBuffer tei = new StringBuffer();
        int nbRespondents = 0;
        int nbAffiliations = 0;
        int nbAddresses = 0;
        ...
        */
        ...
        List<Person> auts = fullRespondents;
        ...
        if (auts != null) {
            ...
            if (nbRespondents > 0) {
                ...
                int contactAut = -1;
                //check if we have a single author of contact
                for (Person respondent : auts) {
                    if (respondent.getEmail() != null) {
                        if (contactAut == -1)
                            contactAut = autRank;
                        else {
                            contactAut = -1;
                ...
                autRank = 0;
                for (Person respondent : auts) {
                    if (respondent.getLastName() != null) {
                        if (respondent.getLastName().length() < 2)
                            continue;
                    }

			        if ( (respondent.getFirstName() == null) && (respondent.getMiddleName() == null) &&
			                (respondent.getLastName() == null) ) {
						continue;
					}

                    TextUtilities.appendN(tei, '\t', nbTag);
                    tei.append("<respondent");
                    ...
                    String localString = respondent.toTEI(withCoordinates);
                    localString = localString.replace(" xmlns=\"http://www.tei-c.org/ns/1.0\"", "");
                    tei.append(localString).append("\n");
                    if (respondent.getEmail() != null) {
                        TextUtilities.appendN(tei, '\t', nbTag + 1);
                        tei.append("<email>" + TextUtilities.HTMLEncode(respondent.getEmail()) + "</email>\n");
                    }
                    if (respondent.getORCID() != null) {
                        TextUtilities.appendN(tei, '\t', nbTag + 1);
                        tei.append("<idno type=\"ORCID\">" + TextUtilities.HTMLEncode(respondent.getORCID()) + "</idno>\n");
                    }

                    if (respondent.getAffiliations() != null) {
                        for (Affiliation aff : respondent.getAffiliations()) {
                            this.appendAffiliation(tei, nbTag + 1, aff, config, lexicon);
                        }
                    } else if (collaboration != null) {
                        TextUtilities.appendN(tei, '\t', nbTag + 1);
    ...
    public String toTEIPetitionerlawerBlock(int nbTag, GrobidAnalysisConfig config) {
        StringBuffer tei = new StringBuffer();
        int nbPetitionerlawers = 0;
        int nbAffiliations = 0;
        int nbAddresses = 0;
        ...
        */
        ...
        List<Person> auts = fullPetitionerlawers;
        ...
        if (auts == null)
            nbPetitionerlawers = 0;
        else
            nbPetitionerlawers = auts.size();
        boolean failAffiliation = true;

        //if (getAuthors() != null) {
        if (auts != null) {
            failAffiliation = false;
            if (nbPetitionerlawers > 0) {
                int autRank = 0;
                int contactAut = -1;
                //check if we have a single author of contact
                for (Person petitionerlawer : auts) {
                    if (petitionerlawer.getEmail() != null) {
                        if (contactAut == -1)
                            contactAut = autRank;
                        else {
                            contactAut = -1;
                ...
                autRank = 0;
                for (Person petitionerlawer : auts) {
                    if (petitionerlawer.getLastName() != null) {
                        if (petitionerlawer.getLastName().length() < 2)
                            continue;
                    }

			        if ( (petitionerlawer.getFirstName() == null) && (petitionerlawer.getMiddleName() == null) &&
			                (petitionerlawer.getLastName() == null) ) {
						continue;
					}
                    ...
                    String localString = petitionerlawer.toTEI(withCoordinates);
                    localString = localString.replace(" xmlns=\"http://www.tei-c.org/ns/1.0\"", "");
                    tei.append(localString).append("\n");
                    if (petitionerlawer.getEmail() != null) {
                        TextUtilities.appendN(tei, '\t', nbTag + 1);
                        tei.append("<email>" + TextUtilities.HTMLEncode(petitionerlawer.getEmail()) + "</email>\n");
                    }
                    if (petitionerlawer.getORCID() != null) {
                        TextUtilities.appendN(tei, '\t', nbTag + 1);
                        tei.append("<idno type=\"ORCID\">" + TextUtilities.HTMLEncode(petitionerlawer.getORCID()) + "</idno>\n");
                    }

                    if (petitionerlawer.getAffiliations() != null) {
                        for (Affiliation aff : petitionerlawer.getAffiliations()) {
                            this.appendAffiliation(tei, nbTag + 1, aff, config, lexicon);
                        }
                    } else if (collaboration != null) {
                        TextUtilities.appendN(tei, '\t', nbTag + 1);
    ...
    public String toTEIRespondentlawerBlock(int nbTag, GrobidAnalysisConfig config) {
        StringBuffer tei = new StringBuffer();
        int nbRespondentlawers = 0;
        int nbAffiliations = 0;
        int nbAddresses = 0;
        ...
        */
        ...
        List<Person> auts = fullRespondentlawers;
        ...
        if (auts == null)
            nbRespondentlawers = 0;
        else
            nbRespondentlawers = auts.size();
        boolean failAffiliation = true;

        //if (getAuthors() != null) {
        if (auts != null) {
            failAffiliation = false;
            if (nbRespondentlawers > 0) {
                int autRank = 0;
                int contactAut = -1;
                //check if we have a single author of contact
                for (Person respondentlawer : auts) {
                    if (respondentlawer.getEmail() != null) {
                        if (contactAut == -1)
                            contactAut = autRank;
                        else {
                            contactAut = -1;
                ...
                autRank = 0;
                for (Person respondentlawer : auts) {
                    if (respondentlawer.getLastName() != null) {
                        if (respondentlawer.getLastName().length() < 2)
                            continue;
                    }

			        if ( (respondentlawer.getFirstName() == null) && (respondentlawer.getMiddleName() == null) &&
			                (respondentlawer.getLastName() == null) ) {
						continue;
					}
                    ...
                    String localString = respondentlawer.toTEI(withCoordinates);
                    localString = localString.replace(" xmlns=\"http://www.tei-c.org/ns/1.0\"", "");
                    tei.append(localString).append("\n");
                    if (respondentlawer.getEmail() != null) {
                        TextUtilities.appendN(tei, '\t', nbTag + 1);
                        tei.append("<email>" + TextUtilities.HTMLEncode(respondentlawer.getEmail()) + "</email>\n");
                    }
                    if (respondentlawer.getORCID() != null) {
                        TextUtilities.appendN(tei, '\t', nbTag + 1);
                        tei.append("<idno type=\"ORCID\">" + TextUtilities.HTMLEncode(respondentlawer.getORCID()) + "</idno>\n");
                    }

                    if (respondentlawer.getAffiliations() != null) {
                        for (Affiliation aff : respondentlawer.getAffiliations()) {
                            this.appendAffiliation(tei, nbTag + 1, aff, config, lexicon);
                        }
                    } else if (collaboration != null) {
                        TextUtilities.appendN(tei, '\t', nbTag + 1);
    ...
    public static void correct(BiblioItem bib, BiblioItem bibo) {
        ...
        if (bibo.getPetitioners() != null)
            bib.setPetitioners(bibo.getPetitioners());
        if (bibo.getRespondents() != null)
            bib.setRespondents(bibo.getRespondents());
        if (bibo.getPetitionerlawers() != null)
            bib.setPetitionerlawers(bibo.getPetitionerlawers());
        if (bibo.getRespondentlawers() != null)
            bib.setRespondentlawers(bibo.getRespondentlawers());
        ...
        if (!CollectionUtils.isEmpty(bibo.getFullPetitioners())) {
            if (CollectionUtils.isEmpty(bib.getFullPetitioners()))
                bib.setFullPetitioners(bibo.getFullPetitioners());
            else if (bibo.getFullPetitioners().size() == 1) {
                // we have the corresponding Petitioner 
                // check if the Petitioner exists in the obtained list
                Person auto = (Person) bibo.getFullPetitioners().get(0);
                List<Person> auts = bib.getFullPetitioners();
                if (auts != null) {
                    for (Person aut : auts) {
                        if (StringUtils.isNotBlank(aut.getLastName()) && StringUtils.isNotBlank(auto.getLastName())) {
                            if (aut.getLastName().toLowerCase().equals(auto.getLastName().toLowerCase())) {
                ...
                // we have the complete list of Petitioners so we can take them from the second
                // biblio item and merge some possible extra from the first when a match is 
                // reliable
                for (Person aut : bibo.getFullPetitioners()) {
                    // try to find the Petitioner in the first item (we know it's not empty)
                    for (Person aut2 : bib.getFullPetitioners()) {
        ...
        if (!CollectionUtils.isEmpty(bibo.getFullRespondents())) {
            if (CollectionUtils.isEmpty(bib.getFullRespondents()))
                bib.setFullRespondents(bibo.getFullRespondents());
            else if (bibo.getFullRespondents().size() == 1) {
                // we have the corresponding Respondent 
                // check if the Respondent exists in the obtained list
                Person auto = (Person) bibo.getFullRespondents().get(0);
                List<Person> auts = bib.getFullRespondents();
                if (auts != null) {
                    for (Person aut : auts) {
                        if (StringUtils.isNotBlank(aut.getLastName()) && StringUtils.isNotBlank(auto.getLastName())) {
                            if (aut.getLastName().toLowerCase().equals(auto.getLastName().toLowerCase())) {
                ...
                // we have the complete list of Respondents so we can take them from the second
                // biblio item and merge some possible extra from the first when a match is 
                // reliable
                for (Person aut : bibo.getFullRespondents()) {
                    // try to find the Respondent in the first item (we know it's not empty)
                    for (Person aut2 : bib.getFullRespondents()) {
        ...
        if (!CollectionUtils.isEmpty(bibo.getFullPetitionerlawers())) {
            if (CollectionUtils.isEmpty(bib.getFullPetitionerlawers()))
                bib.setFullPetitionerlawers(bibo.getFullPetitionerlawers());
            else if (bibo.getFullPetitionerlawers().size() == 1) {
                // we have the corresponding Petitionerlawer 
                // check if the Petitionerlawer exists in the obtained list
                Person auto = (Person) bibo.getFullPetitionerlawers().get(0);
                List<Person> auts = bib.getFullPetitionerlawers();
                if (auts != null) {
                    for (Person aut : auts) {
                        if (StringUtils.isNotBlank(aut.getLastName()) && StringUtils.isNotBlank(auto.getLastName())) {
                            if (aut.getLastName().toLowerCase().equals(auto.getLastName().toLowerCase())) {
                ...
                // we have the complete list of Petitionerlawers so we can take them from the second
                // biblio item and merge some possible extra from the first when a match is 
                // reliable
                for (Person aut : bibo.getFullPetitionerlawers()) {
                    // try to find the Petitionerlawer in the first item (we know it's not empty)
                    for (Person aut2 : bib.getFullPetitionerlawers()) {
        ...
        if (!CollectionUtils.isEmpty(bibo.getFullRespondentlawers())) {
            if (CollectionUtils.isEmpty(bib.getFullRespondentlawers()))
                bib.setFullRespondentlawers(bibo.getFullRespondentlawers());
            else if (bibo.getFullRespondentlawers().size() == 1) {
                // we have the corresponding Respondentlawer 
                // check if the Respondentlawer exists in the obtained list
                Person auto = (Person) bibo.getFullRespondentlawers().get(0);
                List<Person> auts = bib.getFullRespondentlawers();
                if (auts != null) {
                    for (Person aut : auts) {
                        if (StringUtils.isNotBlank(aut.getLastName()) && StringUtils.isNotBlank(auto.getLastName())) {
                            if (aut.getLastName().toLowerCase().equals(auto.getLastName().toLowerCase())) {
                ...
                // we have the complete list of Respondentlawers so we can take them from the second
                // biblio item and merge some possible extra from the first when a match is 
                // reliable
                for (Person aut : bibo.getFullRespondentlawers()) {
                    // try to find the Respondentlawer in the first item (we know it's not empty)
                    for (Person aut2 : bib.getFullRespondentlawers()) {
	...
	public boolean rejectAsReference() {
		...
		if (fullAuthors == null) 
			authorSet = false;
		boolean petitionerSet = true;
		if (fullPetitioners == null) 
			petitionerSet = false;
		boolean respondentSet = true;
		if (fullRespondents == null) 
			respondentSet = false;
		boolean petitionerlawerSet = true;
		if (fullPetitionerlawers == null) 
			petitionerlawerSet = false;
		boolean respondentlawerSet = true;
		if (fullRespondentlawers == null) 
			respondentlawerSet = false;

		// normally properties authors and authorList are null in the current Grobid version
		if (!titleSet && !authorSet && !petitionerSet && !respondentSet && !petitionerlawerSet && !respondentlawerSet && (url == null) && (doi == null))
			return true;
		else
			return false;
	}
    ...
    public List<LayoutToken> getPetitionersTokensWorkingCopy() {
        return petitionersTokensWorkingCopy;
    }

    public List<LayoutToken> getRespondentsTokensWorkingCopy() {
        return respondentsTokensWorkingCopy;
    }

    public List<LayoutToken> getPetitionerlawersTokensWorkingCopy() {
        return petitionerlawersTokensWorkingCopy;
    }

    public List<LayoutToken> getRespondentlawersTokensWorkingCopy() {
        return respondentlawersTokensWorkingCopy;
    }
